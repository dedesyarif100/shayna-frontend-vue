                        ...
                        <ul class="nav-right">
                            <li class="cart-icon">
                                ...
                                <a href="#">
                                    ...
                                    <span style="width: 15px; height: 15px;">{{ keranjangUser.length }}</span>
                                </a>
                                <div class="cart-hover">
                                                ...
                                                <tr v-for="keranjang in keranjangUser" :key="keranjang.id">
                                                    ...
                                                    <td class="si-text">
                                                        <div class="product-selected">
                                                            <p>${{ keranjang.price }} x 1 (jumlah barang)</p>
                                    ...
                                    <div class="select-button">
                                        <a href="#" class="primary-btn view-card">
                                            <router-link to="/chart" style="color: #FFF">
                                                VIEW CARD
                                            </router-link>
                                        </a>
                                        <a @click="checkout()" href="#" class="primary-btn checkout-btn">CHECK OUT</a>
                                    </div>
                                </div>
                            </li>
                        </ul>
...
export default {
    ...
    methods: {
        // Fungsi untuk menghapus data menggunakan method splice
        removeItem(index) {
    ...
    computed: {
        // Fungsi untuk menambah total harga
        totalHarga() {
